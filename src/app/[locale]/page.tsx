...
export async function generateMetadata({
  ...
  return {
    // `absolute` skips the layout's "%s | Casa in Ordine" template: the homepage
    // title already carries the brand, so templating would double-brand it.
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <Hero
        title={t('hero.title')}
        eyebrow={t('hero.brand')}
        subtitle={t('hero.subtitle')}
        cta={{ text: t('hero.cta'), href: `/${locale}/contact` }}
        backgroundImages={[
          '/images/backgrounds/hero1.webp',
          '/images/backgrounds/hero2.webp',
          '/images/backgrounds/hero3.webp',
        ]}
        interval={6000}
        large
      />
