...
Molte case, soprattutto a Roma, non hanno un vero ingresso: si entra direttamente in un corridoio o nel soggiorno. In questi casi la parola d'ordine è **[sfruttare la verticale](/it/blog/come-risparmiare-spazio-in-casa)**.
